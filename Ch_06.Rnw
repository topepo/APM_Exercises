...
\begin{figure}
  \begin{center}  
<<ch06_meat_pls_plot, echo = FALSE, fig.width=7, fig.height=4.5,out.width='.8\\linewidth'>>=
bookTheme()
...
\begin{figure}[t]
  ...
  \begin{center}  
<<ch06_meat_enet_plot, echo = FALSE, fig.width=7, fig.height=4.5,out.width='.8\\linewidth'>>=
bookTheme()
...
\begin{figure}[ht]
  \begin{center}  
<<ch06_permeabilityPLSTunePlot, , echo = FALSE, results='hide', fig.width=7, fig.height=4.5,out.width='.8\\linewidth'>>=
plotTheme <- bookTheme()
trellis.par.set(plotTheme)
...
\begin{figure}[ht]
\begin{center}
<<ch06_permeabilityPLSCompPlot, echo = FALSE, results='hide', fig.width=8, fig.height=4,out.width='1\\linewidth'>>=
library(reshape2)  
...
\begin{figure}[t]
  \begin{center}  
  <<ch06_yieldDistribution, echo = FALSE, fig.width=7, fig.height=4.5,out.width='.8\\linewidth'>>=
plotTheme <- bookTheme()
trellis.par.set(plotTheme)
...
\begin{figure}[h]
\begin{center}  
<<ch06_ex3PLSTune, echo = FALSE, fig.width=7, fig.height=4.5,out.width='.8\\linewidth'>>=
plotTheme <- bookTheme()
trellis.par.set(plotTheme)
plot(plsTune,metric="Rsquared")
@
